...
module.exports = {
     ...
     */
    Sign: function (suite, message, anonymitySet, linkScope, mine, privateKey) {
     ...
     */
    Verify: function (suite, message, anonymitySet, linkScope, signatureBuffer) {
        if (!(suite instanceof Kyber.Group)) {
            throw "suite must be an instance of a Group";
        }
        if (!(message instanceof Uint8Array)) {
     ...
     * @return {Uint8Array} - the signature
     */
    SignWithBadge: function (b, message, scope) {
